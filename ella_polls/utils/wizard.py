...
It is ported from django 1.5 and was removed in django 1.6 and was recommanded
to use the class-based views in django.contrib.formtools.wizard.views instead
